...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <li><asp:Label ID="Label2" runat="server" Text="Telefone:"></asp:Label> </li>
    ...
    <li><asp:TextBox ID="txtTexto" runat="server" CssClass="details" Height="88px"  Width="191px"></asp:TextBox></li>
